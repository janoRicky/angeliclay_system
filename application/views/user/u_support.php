									...
									for ($i = count($messages) - 1; $i >= 0; $i--): 
										...
										<?php if ($row["admin_id"] == NULL): ?>
											<div class="row m-1 align-items-center">
												...
												<div class="col-8 bg-primary mr-auto px-3 py-2 text-right" style="color: #fff; border-radius: 0.35rem; word-break: break-word; max-width: 90%;">
													<?=$row["message"]?>
												</div>
											</div>
										<?php else: ?>
											<div class="row m-1 align-items-center">
												<div class="col-8 bg-secondary ml-auto px-3 py-2 text-left" style="color: #fff; border-radius: 0.35rem; word-break: break-word;">
													<?=$row["message"]?>
												</div>
												<div class="col-4 font-italic text-center" style="color: grey; font-size: 0.75rem;">
